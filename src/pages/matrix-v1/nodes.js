export const nodes = [
  ...
  { id: 'stabilize', position: { x: 100, y: 300 }, data: { label: 'Stabilize (Puzzle)', tooltip: 'Puzzle node (under construction)', type: 'choice', status: 'wip', recommended: true }, type: 'choice' },
