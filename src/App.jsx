    ...
    <Router>
      <div className="min-h-screen bg-gray-900 text-white">
        ...
        <nav className="bg-gray-800 p-4">
          {/* flex-nowrap keeps pills on ONE line; overflow-x lets you swipe on tiny screens */}
          <div className="container mx-auto flex flex-nowrap overflow-x-auto gap-4">
            ...
            <Link to="/lego-builder"   className="px-3 py-1.5 rounded-full bg-red-600    hover:bg-red-500    transition-colors">LEGO Builder</Link>
            <Link to="/lego-inventory" className="px-3 py-1.5 rounded-full bg-yellow-600 hover:bg-yellow-500 transition-colors">LEGO Inventory</Link>
        ...
        <div className="container mx-auto p-4">
          <Routes>
            ...
            <Route path="/snack-trail"    element={<SnackTrail />} />
