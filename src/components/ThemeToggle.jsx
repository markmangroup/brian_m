  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div 
          className={`
            absolute top-full mt-2 right-0 min-w-48 rounded-lg shadow-xl border backdrop-blur-md z-50
            ${currentTheme === 'matrix' ? 'bg-black/90 border-green-400/30' : ''}
            ${currentTheme === 'witcher' ? 'bg-amber-900/90 border-amber-400/30' : ''}
            ${currentTheme === 'nightcity' ? 'bg-gray-900/90 border-purple-400/30' : ''}
          `}
          style={{
            backgroundColor: currentThemeData?.colors?.overlayBackground,
            borderColor: currentThemeData?.colors?.borderSecondary,
            boxShadow: currentThemeData?.colors?.shadowPrimary
          }}
        >
          <div className="p-2">
              ...
              return (
                <button
                  ...
                  className={`
                    ...
                    transition-all duration-200 hover:scale-[0.98] group
